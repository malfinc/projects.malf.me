defmodule Core.Gameplay.Match do
  ...
  schema "matches" do
    field(:rounds, {:array, :string}, default: [])
    ...
    belongs_to(:winning_champion, Core.Gameplay.Champion)

    timestamps()
  end

  @type t :: %__MODULE__{
          rounds: list(String.t())
        }
  ...
  def changeset(record, attributes) do
    ...
    record_with_preload
    |> Ecto.Changeset.cast(attributes, [:rounds])
    ...
    |> Ecto.Changeset.put_assoc(
      :winning_champion,
      attributes[:winning_champion] || record_with_preload.winning_champion
    )
    ...
    |> Ecto.Changeset.foreign_key_constraint(:winning_champion_id)
  end
end
